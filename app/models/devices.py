...
class Device(db.Model):
    ...
    id = db.Column(
        "id", db.Integer(), nullable=False, unique=True,primary_key=True, autoincrement=True
    )
    ...
    locations = db.relationship("Location", back_populates="device", cascade="all, delete-orphan")
